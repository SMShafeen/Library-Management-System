        ...
        <main>
            <div class="header">
                <div class="left">
                    ...
                    <ul class="breadcrumb">
                        ...
                        /
                        <li><a href="#" class="active">Borrow History</a></li>
                    </ul>
                </div>
            </div>
            ...
            <div class="table-data" style="margin-top:20px;">
                <table id="tableData" class="ui celled table table-striped hover" style="width:100%;">
                    ...
                    <tbody>
                        <?php
                            $sql_bb = mysqli_query($conn, "SELECT * FROM borrowed_book WHERE User_ID = $student_id");
                            if(mysqli_num_rows($sql_bb) > 0){
                                ...
                                while($bb_row = mysqli_fetch_assoc($sql_bb)){
                                    ...
                                    echo "<tr>
                                            ...
                                            <td>
                                                <a href='student_borrowed_books.php?update=".$bb_row['ID']."' class='option-btn' style='margin-right: 3px;'>Detail</a>
                                            </td>
                                        </tr>";
                                }
                            }
        ...
        <section class="update">
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <div class="field">
                    ...
                    <input type="text" class="box" value="<?php echo $fetch_update['Return_Status']; ?>">
                </div>
                <!-- <input type="submit" class="btn" name="update_bd" value="update" style="margin-top:10px; margin-right:5px;"> -->
                <input type="reset" id="close-update" class="option-btn" name="cancel" value="close" style="margin-top:10px; width:100%;">
...
<script>
    ...
    const manageUsers = document.querySelector(".side-menu li:nth-child(4)");
    ...
    if(closeBtn){
        closeBtn.onclick = ()=> {
            ...
            window.location.href = 'student_borrowed_books.php';
        };
    }
